<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
  <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0"
          ...
          <span class="font-weight-bold text-lg">Desa Bojonggede</span>
      </a>
  </div>
  <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
          ...
          <hr class="animasi-hr">
          <div class="ms">Kegiatan Desa</div>
          @can('kategori-list')
          <li class="nav-item">
              <a class="nav-link  {{ request()->routeIs('kategori_kegiatan.index') ? 'active' : '' }}" href="{{ route('kategori_kegiatan.index') }}">
                  <div
                      class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                      <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <title>kategori kegiatan</title>
                          <g id="kategori_kegiatan" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          @endcan
          @can('laporankegiatan-list')
          <li class="nav-item">
            <a class="nav-link  {{ request()->routeIs('laporan_kegiatan.index') ? 'active' : '' }}" href="{{ route('laporan_kegiatan.index') }}">
                <div
                    class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>Laporan Kegiatan</title>
                        <g id="laporan_kegiatan" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                fill-rule="nonzero">
                                <path class="color-foreground"
                                    d="M3.42857143,0 C1.53502286,0 0,1.53502286 0,3.42857143 L0,6.85714286 C0,8.75069143 1.53502286,10.2857143 3.42857143,10.2857143 L6.85714286,10.2857143 C8.75069143,10.2857143 10.2857143,8.75069143 10.2857143,6.85714286 L10.2857143,3.42857143 C10.2857143,1.53502286 8.75069143,0 6.85714286,0 L3.42857143,0 Z"
        ...
        @can('proyek-list')
        <hr class="animasi-hr">
        <div class="ms">Proyek Desa</div>
          <li class="nav-item">
              <a class="nav-link  {{ request()->routeIs('proyek.index') ? 'active' : '' }}" href="{{ route('proyek.index') }}">
                  <div
                      class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                      <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <title>Proyek</title>
                          <g id="proyek" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                  fill-rule="nonzero">
                                  <path class="color-foreground"
                                      d="M3.42857143,0 C1.53502286,0 0,1.53502286 0,3.42857143 L0,6.85714286 C0,8.75069143 1.53502286,10.2857143 3.42857143,10.2857143 L6.85714286,10.2857143 C8.75069143,10.2857143 10.2857143,8.75069143 10.2857143,6.85714286 L10.2857143,3.42857143 C10.2857143,1.53502286 8.75069143,0 6.85714286,0 L3.42857143,0 Z"
          ...
          @can('laporan-list')
          <li class="nav-item">
              <a class="nav-link  {{ request()->routeIs('laporan_proyek.index') ? 'active' : '' }}" href="{{ route('laporan_proyek.index') }}">
                  <div
                      class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                      <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <title>Laporan Proyek</title>
                          <g id="laporan_proyek" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                  fill-rule="nonzero">
                                  <path class="color-foreground"
                                      d="M3.42857143,0 C1.53502286,0 0,1.53502286 0,3.42857143 L0,6.85714286 C0,8.75069143 1.53502286,10.2857143 3.42857143,10.2857143 L6.85714286,10.2857143 C8.75069143,10.2857143 10.2857143,8.75069143 10.2857143,6.85714286 L10.2857143,3.42857143 C10.2857143,1.53502286 8.75069143,0 6.85714286,0 L3.42857143,0 Z"
                  ...
                  <span class="nav-link-text ms-1">Laporan Proyek</span>
              </a>
          </li>
          @endcan
          <hr class="animasi-hr">
          <li class="nav-item mt-2">
              <div class="d-flex align-items-center nav-link">
                  ...
                  <span class="font-weight-normal text-md ms-2">Users </span>
              </div>
          </li>
          ...
          @can('user-list')
          <li class="nav-item border-start my-0 pt-2">
              <a class="nav-link position-relative ms-0 ps-2 py-2 {{ request()->routeIs('users.index') ? 'active' : '' }}"
          ...
          @can('role-list')
          <li class="nav-item border-start my-0 pt-2">
              <a class="nav-link position-relative ms-0 ps-2 py-2 {{ request()->routeIs('roles.index') ? 'active' : '' }}"
