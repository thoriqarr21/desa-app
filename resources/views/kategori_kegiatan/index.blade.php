            ...
            <div class="card-header border-bottom pb-0">
                <div class="d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <a href="{{ route('kategori_kegiatan.create') }}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center justify-content-center mb-0 me-2">
                    ...
                    <table class="table align-items-center justify-content-center mb-0">
                        <thead class="bg-gray-100 text-center ">
                            <tr>
                                ...
                                <th class="text-secondary  font-weight-semibold opacity-7 ps-3">
                                    Nama Kategori Kegiatan</th>
                                <th class="text-secondary  font-weight-semibold opacity-7 ps-2">
                                    Deskripsi Kategori Kegiatan</th>
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td>
                                    <span class="fs-6 font-weight-normal">{{ $kategoriKegiatan->deskripsi_kategori }}</span>
                                </td>
