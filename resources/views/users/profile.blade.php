                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="profile-image-wrapper" style="width: 100px; height: 100px; border-radius: 50%; overflow: hidden; border: 4px solid #1b1b1b; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                            @if($user->gambar)
                            <img src="{{ $user->gambar }}" alt="Foto Profil" class="img-fluid" style="width: 100%; height: 100%; object-fit: cover;">
                        @else
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 text-center">
                                        <div class="profile-image-upload-wrapper mx-auto" 
                                            ...
                                            <img src="{{ $user->gambar ? asset($user->gambar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=5e35b1&color=fff&size=128' }}" 
                                                 alt="Foto Profil" 
                                                 class="img-fluid" 
...
<script>
    ...
    const clicker = document.getElementById('profileImageClickArea');
    clicker.addEventListener('click', () => input.click());
