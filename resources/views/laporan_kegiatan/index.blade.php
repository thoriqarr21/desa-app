            ...
            <div class="card-body px-0 py-0">
                ...
                <form method="get" onsubmit="event.preventDefault(); exportPDF();">
                    <div class="d-flex gap-2 mb-2">
                        ...
                        <button type="submit" class="btn btn-danger" style="height: 45px; align-self: flex-end">
                            <i class="fas fa-file-pdf"></i> Export PDF
                        </button>
                
                        <button type="button" class="btn btn-success" onclick="exportExcel()" style="height: 45px; align-self: flex-end">
