   ...
   <div class="nomor">Nomor : 140/{{ $nomorUrutFormatted }}/LapKeg/{{ $bulanRomawiFormatted }}/{{ $tahun }}</div>
    <table class="detail">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $i + 1 }}</td>
                <td class="name-text">{{ $item->kegiatan->nama_kegiatan ?? '-' }}</td>
                <td class="tanggal-text">{{ $item->kegiatan->tanggal_mulai ?? '-' }} s/d {{ $item->kegiatan->tanggal_selesai ?? '-' }}</td>
                <td class="justify-text">{{ $item->tujuan_kegiatan }}</td>
                <td class="justify-text">{{ $item->hasil }}</td>
                <td class="justify-text">{{ $item->evaluasi }}</td>
                <td>      
