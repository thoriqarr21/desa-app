<table>
    ...
    <tr>
        ...
        <td style="text-align: center;">{{ optional($item->kegiatan)->tanggal_mulai ? \Carbon\Carbon::parse($item->kegiatan->tanggal_mulai)->format('d-m-Y') : '-' }} s/d {{ optional($item->kegiatan)->tanggal_selesai ? \Carbon\Carbon::parse($item->kegiatan->tanggal_selesai)->format('d-m-Y') : '-' }}</td>
