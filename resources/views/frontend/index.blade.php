...
<hr class="animated-hr">
  <div class="row">
    <div class="col-xl-3 col-sm-6 mb-xl-0">
        <div class="card-data border shadow-xs mb-4">
                    ...
                    <div class="col-12">
                        <div class="w-100">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-sm ms-2">Jumlah Data</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 h-80">
        <div class="card-data border shadow-xs mb-4">
            <div class="card-body text-start p-3 w-100">
                <div
                    class="icon icon-shape icon-sm bg-dark text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3">
      ...
      <div class="col-md-4 mb-4">
        <div class="card border dash-pegawai">
          ...
          <div class="card-body">
            ...
            <div class="card-status border-start status">
              <div class="card-body d-flex justify-content-between align-items-center">
                <div>
...
<script>
        var map = L.map('map').setView([-6.4, 106.8], 12);
...
.icon-shape {
    background: linear-gradient(45deg, var(--primary-color), #6666bb); /* Gradient for icons */
    color: #ffffff;
...
.status.card {
    ...
    &.border-start:nth-child(1) { border-color: var(--tertiary-color); } /* Perencanaan */
    &.border-start:nth-child(2) { border-color: var(--secondary-color); } /* Berjalan */
    &.border-start:nth-child(3) { border-color: var(--primary-color); } /* Selesai */
}
...
#progresChart, #kegiatanBarChart, #rasioChart, #calendar {
    padding: 1rem;
    background-color: var(--card-background);
    border-radius: 0.75rem;
}
