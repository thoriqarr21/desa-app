...
<style>
    ...
    /* Header Card (Buat Laporan proyek) */
    .header-card-wrapper {
            ...
            <div class="header-card">
                <div class="d-flex align-items-center justify-content-center">
                    <h4 class="fw-bold text-dark mb-0">
                        <i class="bi bi-pencil-square"></i> Buat Laporan proyek
                    </h4>
                </div>
            </div>
        </div>
    ...
    <div class="card main-form-card">
        <div class="card-body p-4">
            <form action="{{ route('frontend.laporan_proyek.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4 align-items-center form-section">
                    <div class="col-md-3">
                        <label for="persentase" class="form-label-custom">Persentase Progres Awal</label>
                    </div>  
                    <div class="col-md-9">
                        <div class="position-relative">
                            <i class="bi bi-pencil-square position-absolute top-50 start-0 translate-middle-y ms-3 text-success"></i>
                ...
                <div class="row mb-4 form-section">
                    ...
                    <div class="col-md-9">
                        <textarea name="keterangan" class="form-control form-control-custom" rows="5" placeholder="Masukkan Keterangan Proyek"></textarea>
                    </div>
                </div>
                ...
                <div class="row mb-4 form-section">
                    ...
                    <div class="col-md-9">
                        <textarea name="kendala" class="form-control form-control-custom" rows="3" placeholder="Masukkan Kendala Proyek"></textarea>
                    </div>
                </div>
                ...
                <div class="row mb-4 form-section">
                    ...
                    <div class="col-md-9">
                        <textarea name="evaluasi" class="form-control form-control-custom" rows="3" placeholder="Masukkan Evaluasi Proyek"></textarea>
                    </div>
                </div>
