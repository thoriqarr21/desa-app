...
<div class="container-fluid py-3 mb-5">
    {{-- <div class="d-flex justify-content-between align-items-center margin-tb">
        <div class="d-flex align-items-center ms-3">
            <a class="btn btn-back-custom" href="{{ route('frontend.laporan_proyek.index') }}">
    ...
    <div class="card main-form-card">
        <div class="card-body p-4">
            <form action="{{ route('frontend.laporan_proyek.update', $laporanProyek) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-4 align-items-center form-section">
                    <div class="col-md-3">
                        <label for="proyek_id" class="form-label-custom">Nama proyek</label>
                    </div>  
                    <div class="col-md-9">
                        <div class="position-relative">
                            <i class="bi bi-pencil-square position-absolute top-50 start-0 translate-middle-y ms-3 text-success"></i>
                            <select name="proyek_id" id="proyek_id" class="form-select ps-5 rounded-3 border border-success" required>
                ...
                <div class="row mb-4 align-items-center form-section">
                    <div class="col-md-3">
                        <label for="persentase" class="form-label-custom">Persentase</label>
                    </div>
                    <div class="col-md-9">
                        <div class="position-relative">
                            <i class="bi bi-pencil-square position-absolute top-50 start-0 translate-middle-y ms-3 text-success"></i>
                ...
                <div class="row mb-4 form-section">
                    <div class="col-md-3">
                        <label for="keterangan" class="form-label-custom">Keterangan proyek</label>
                    </div>
                    <div class="col-md-9">
                        <textarea name="keterangan" class="form-control form-control-custom" rows="5" placeholder="Bantuan">{{ old('keterangan', $laporanProyek->keterangan) }}</textarea>
                    </div>
                </div>

                <div class="row mb-4 form-section">
                    <div class="col-md-3">
                        <label for="kendala" class="form-label-custom">kendala</label>
                    </div>
                    <div class="col-md-9">
                        <textarea name="kendala" class="form-control form-control-custom" rows="3">{{ old('kendala', $laporanProyek->kendala) }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-4 form-section">
                    ...
                    <div class="col-md-9">
                        <textarea name="evaluasi" class="form-control form-control-custom" rows="3">{{ old('evaluasi', $laporanProyek->evaluasi) }}</textarea>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary-custom">update Now</button>
                </div>
            </form>
        </div>
    </div>
